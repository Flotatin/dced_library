...
class UiLayoutMixin:
    ...
    def _setup_tab_gauge(self):
        ...
        # ================== Segment Gauge ==================
        self.peak_fit_line_layout.addWidget(QLabel("Gauge:"))
        self.name_gauge = QLabel("ADD:")
        self.peak_fit_line_layout.addWidget(self.name_gauge)
        ...
        self.peak_fit_line_layout.addWidget(self.Gauge_type_selector)

        self.lamb0_entry = QLineEdit()
        self.lamb0_entry.setMaximumWidth(80)
        self.peak_fit_line_layout.addLayout(creat_spin_label(self.lamb0_entry, "λ<sub>0</sub>:"))
        ...
        self.peak_fit_line_layout.addLayout(creat_spin_label(self.name_spe_entry, "G.spe:"))
        ...
        self.peak_fit_line_layout.addWidget(QLabel("Model:"))
        ...
        self.peak_fit_line_layout.addLayout(self.ParampicLayout)
        ...
        self.peak_fit_line_layout.addLayout(creat_spin_label(self.sigma_pic_fit_entry, "nbσ:"))
        ...
        self.peak_fit_line_layout.addLayout(creat_spin_label(self.inter_entry, "var%:"))
        ...
        self.peak_fit_line_layout.addLayout(creat_spin_label(self.index_start_entry, "start:"))
        ...
        self.peak_fit_line_layout.addLayout(creat_spin_label(self.index_stop_entry, "stop:"))

        self.add_btn = QPushButton("+ zone")
        self.add_btn.clicked.connect(self.add_zone)
        self.peak_fit_line_layout.addWidget(self.add_btn)

        self.remove_btn = QPushButton("- zone")
        self.remove_btn.clicked.connect(self.dell_zone)
        self.remove_btn.setEnabled(False)
        self.peak_fit_line_layout.addWidget(self.remove_btn)
        ...
        self.peak_fit_line_layout.addWidget(self.btn_zone_dpdt)
        ...
        self.peak_fit_line_layout.addWidget(self.chk_multi_fit_fast)
